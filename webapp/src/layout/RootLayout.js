...
const RootLayout = () => {
    ...
    return (_jsxs("div", { className: "app-root-safe", children: [_jsx(TelegramBackSync, {}), _jsx(Header, { onMenuClick: () => setMenuOpen(true), user: user }), _jsx("div", { className: "pt-[56px]" }), _jsx("main", { className: "app-main", children: _jsx("div", { className: "screen-fade-in", children: _jsx(Outlet, {}) }, location.pathname) }), _jsx(BottomNav, {}), _jsx(BurgerMenu, { open: menuOpen, onClose: () => setMenuOpen(false), user: user })] }));
};
